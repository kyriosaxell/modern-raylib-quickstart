...
vpaths
{
    ["Header Files"] = { raylib_dir .. "/src/**.h", raylib_dir .. "/src/**.hpp" },
    ["Source Files/*"] = { raylib_dir .. "/src/**.cpp", raylib_dir .. "/src/**.c" },
}
files { raylib_dir .. "/src/*.h", raylib_dir .. "/src/*.hpp", raylib_dir .. "/src/*.cpp", raylib_dir .. "/src/*.c" }
